...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 18, 2022 at 10:49 AM
...
CREATE TABLE `news` (
  ...
  `short_desc` text COLLATE cp1250_croatian_ci,
  `content` text COLLATE cp1250_croatian_ci,
...
(1, 'luchenac', 'lukabican18@gmail.com', '$2y$10$kXfDZIpRjlzsZMFw5gOPb.MaakyK1JBL2eZ2CKWe3eM36cdn8K7z.', 2),
(2, 'admin', 'admin@ztimes', '$2y$10$r3JCZv/SBoOUbsFDFzOrhOzf1q0DlRAwOi69rnEW16Z7aC8RTpJlS', 2);
